...
clutter_intensity = @(z) lambda_c * V * unifpdf_2d(xrange, yrange, z);%Generate clutter function. There are caveats to its use for clutter outside of xrange or yrange - see the comments in unifpdf_2d.m
