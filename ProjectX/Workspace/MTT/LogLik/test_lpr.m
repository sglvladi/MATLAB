...
Params_pf.gen_x0 = @(x,Np) [mvnrnd(repmat(x',Np,1),diag([Params_po.r^2, Params_po.r^2, 0, 0])), 1*rand(Np,1), 2*pi*rand(Np,1)]';
...
%     end
    ...
    THD  = -20.9;
    [jpdaf, pdaf, TrackIds] =  LogLikRatio_TM(jpdaf, pdaf, [0.1,10^-6,THD], initFilter, TrackIds);
