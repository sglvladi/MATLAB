...
[x1,F]=jaccsd(s.A,s.x);    %nonlinear update and linearization at current state
P=F*s.P*F'+s.Q;                 %partial update
P = abs(P);
[z1,H]=jaccsd(s.H,x1);    %nonlinear measurement and linearization
S=H*P*H'+ s.R;
K=P*H'/S;
