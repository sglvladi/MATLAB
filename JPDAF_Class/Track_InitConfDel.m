...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    THD = -30.9;                         % Deletion threshold diff (from Blackman & Popoli)
    Vmax = 0.4;
    ...
    for i=1:TrackNum
        ...
        if (TrackList{TrackInd}.TrackObj.pf.LPR < gamma_low)%TrackList{TrackInd}.TrackObj.pf.LPR_max+THD)
...
%     end
    ...
    THD = -8.9;                         % Deletion threshold diff (from Blackman & Popoli)
    Vmax = 0.4;
