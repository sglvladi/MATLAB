function [betta_overall] = buildAssocTree(ValidationMatrix, Li, bettaNTFA)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     Li
    ...
    betta(size(DataInd,1)+1) = getAssocProb(PointNum+1,i, NetList{cluster_id}.HypMap, NetList{cluster_id}.HypProb);
    betta_overall(i,size(DataInd,1)+2) = betta(size(DataInd,1)+1);
    betta;
    % Back-up code
    % ========================================================================>
